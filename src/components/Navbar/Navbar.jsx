...
export default function Navbar() {
  return (
    <header className="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
      <nav className="mt-4 relative max-w-6xl w-full bg-white border border-gray-200 rounded-[2rem] mx-2 py-2.5 px-6 md:flex md:items-center md:justify-between md:py-0 md:px-8 md:mx-auto dark:bg-neutral-900 dark:border-neutral-700">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-end gap-2 md:gap-3 mt-3 md:mt-0 py-2 md:py-0 md:ps-7">
            ...
            <a
              href="#profile"
              className="py-0.5 md:py-3 px-4 md:px-1 border-s-2 md:border-s-0 md:border-b-2 border-transparent font-medium text-gray-800 focus:outline-none dark:text-neutral-200"
              aria-current="page"
            >
              Profile
            </a>
